...
function LangtonsAnt() {
  ...
  return (
    <div className='p-2 h-[90%] bg-background'>
      <h3 className="text-2xl font-bold p-2 text-accent-amber">Langton's Ant</h3>
      ...
      <div className="p-6 flex flex-col lg:flex-row gap-4 h-full overflow-auto">
        ...
        <div className="flex flex-col gap-3 w-full lg:w-72 shrink-0 rounded-xl border-l-4 border-l-accent-amber border bg-card p-5 shadow-sm">
          <h5 className="text-lg font-bold text-accent-amber">Langton's Ant Controls</h5>
